...
#ifdef GEOIP_EXPORTS
#define GEOIP_API __declspec( dllexport ) //DLLÊä³ö
#else

#ifdef _LIB
#define GEOIP_API
#else
#define GEOIP_API __declspec( dllimport ) //DLLÊäÈë
#endif
#endif

extern GEOIP_API char **GeoIPDBFileName;
extern GEOIP_API const char * GeoIPDBDescription[NUM_DB_TYPES];
...
extern GEOIP_API const char GeoIP_country_code[253][3];
extern GEOIP_API const char GeoIP_country_code3[253][4];
extern GEOIP_API const char * GeoIP_country_name[253];
extern GEOIP_API const char GeoIP_country_continent[253][3];
...
GEOIP_API void _GeoIP_uninstall_dbfilename();
